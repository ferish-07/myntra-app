      ...
      <SafeAreaView style={{backgroundColor: 'white', flex: 1}}>
        ...
        <ScrollView
          ...
          onScroll={(event: NativeSyntheticEvent<NativeScrollEvent>) => {
            console.log('eventtt-->>', event.nativeEvent.contentOffset.y);
            if (event.nativeEvent.contentOffset.y - 40 >= global.ViewHeight) {
              setBottomViewVisible(false);
            }
            if (event.nativeEvent.contentOffset.y + 5 <= global.ViewHeight) {
                ...
                return (
                  <View
                    style={{
                      ...
                      height: 8,
                      backgroundColor:
                        currentIndex == index ? '#282c3e' : 'gray',
                      borderRadius: 100,
                      margin: 2,
                    }}
                  />
          ...
          <View style={{marginHorizontal: 18}}>
            <View
              ...
              <Text
                style={{color: '#262a39', fontWeight: 'bold', fontSize: 18}}>
                Delivery & Services
              </Text>
              <View
                style={{
